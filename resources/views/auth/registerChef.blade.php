    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-danger " style="color:white">INSCRIPTION:</div>

                <div class="card-body">
                <form method="POST" action="{{ route('registerchef') }}" enctype="multipart/form-data">
                @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <label for="photo" class="text-md-right">Votre photo:</label>

                                <!-- <div class="custom-file"> -->
                                <input id="file" type="file" name="photo" class="form-control" />
                                    <!-- <input type="file" name="photo" class="custom-file-input" id="customFile" lang="fr"> -->
